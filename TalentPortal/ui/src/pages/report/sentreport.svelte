<script>
    ...
    import { getReportById, getSentReport } from "../../api/report_api";
...
<div class="row">
    <div class="col-md-12">
        <BreadCrumb title="Sent Report" path={window.location.pathname} />
    </div>
</div>
                ...
                {#each $reports as report}
                    <tr>
                        ...
                        <td class="text-center"
                            >{new Date(report.date).toLocaleDateString()}</td
                        >
